...
export class UllUUID {
  public static readonly REGULAR_EXPRESSION =
    /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/;
  public static readonly ERROR_NOT_DEFINED =
    "UUID of the resource is not defined";
  public static readonly ERROR_EMPTY = "UUID of the resource cannot be empty";
  public static readonly ERROR_WRONG_FORMAT =
    "UUID of the resource must only contain alphanumeric characters separated by '-'";
  public static readonly ERROR_LENGTH =
    "UUID must be represented by 36 characters (32 hex digits + 4 dashes)";
